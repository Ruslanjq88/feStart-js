...
const getElAll = els => document.querySelectorAll(els)

const inputDisplay = getEl("#history")
const outputDisplay = getEl("#result")

const allClearButton = getEl("[data-all-clear]")
const backspaceButton = getEl("[data-backspace]")
const percentButton = getEl("[data-percent]")
const operationButtons = getElAll("[data-operator]")
const numberButtons = getElAll("[data-number]")
const negationButton = getEl("[data-negation]")
const decimalButton = getEl("[data-decimal]")
const equalsButton = getEl("[data-equals]")
